                ...
                <ul>
                  <li> 
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <img src={'./iitj.png'} alt="IIT Jodhpur Logo" style={{ height: '70px', marginRight: '28px' }} />
                      <div>
                  ...
                  <li> 
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <img src={'./gvhs.png'} alt="GVHS Logo" style={{ height: '70px', marginRight: '23px' }} />
                      <div>
                  ...
                  <li> 
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <img src={'./skis.jpg'} alt="SKIS Logo" style={{ height: '70px', marginRight: '18px' }} />
                      <div>
